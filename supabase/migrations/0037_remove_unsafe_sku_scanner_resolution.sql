-- Quita sku de la resolucion de escaneo porque sku no identifica talla de forma unica.
-- La RPC reconoce codigo canonico y aliases, siempre como texto exacto.
